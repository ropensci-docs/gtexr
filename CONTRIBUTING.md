# Contributing to gtexr

This outlines how to propose a change to gtexr. For a detailed
discussion on contributing to this and other packages emulating
tidyverse style, please see the tidyverse [development contributing
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("ropensci/gtexr", fork = TRUE)`.
...
of Conduct](https://docs.ropensci.org/gtexr/CODE_OF_CONDUCT.md). By
